...
const ContactUs = () => {
      ...
      <form className="max-w-2xl mx-auto bg-white p-8 shadow-md rounded-2xl space-y-6">
        <input type="text" placeholder="Your Name" className="w-full border-b-2 p-3 focus:outline-none focus:border-blue-500" />
        <input type="email" placeholder="Your Email" className="w-full border-b-2 p-3 focus:outline-none focus:border-blue-500" />
        <textarea placeholder="Your Message" rows={5} className="w-full border-b-2 p-3 focus:outline-none focus:border-blue-500"></textarea>
